 ...
 */
final class Version20210302163534 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE document ALTER uri SET NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE document ALTER uri DROP NOT NULL');
        $this->addSql('DROP INDEX dublin_core_uk');
